...
class ErrorHandler
{
    ...
    public static $invalidIndustryError = "Vennligst, velg en gyldig bransje!";
    public static $emptyInputJobTypeError  = "Vennligst, velg en ansettelsesform!";
    public static $emptyInputApplicationDeadlineError = "Vennligst, velg en gyldig søknadsfrist dato!";
    public static $isOldApplicationDeadlineDateError = "Søknadsfrist dato er ugyldig. Vennligst, velg en gyldig søknadsfrist dato!";

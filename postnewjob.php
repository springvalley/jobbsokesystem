    ...
    <form action="./controllers/JobListingController.php" method="post">
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-sm-8 form-group">
                ...
                ?>
                <label for="jobTitle"><?php echo translate("job_title_label") ?></label>
                <input type="text" class="form-control" name="jobTitle"
                    placeholder="<?php echo translate("job_title_placeholder") ?>"
                    value="<?php echo htmlspecialchars($jobTitle); ?>">
            </div>

            <div class="col-sm-8 form-group">
                <label for="positionName"><?php echo translate("position_name_label") ?></label>
                <input type="text" class="form-control" name="positionName"
                    placeholder="<?php echo translate("position_placeholder") ?>"
            ...
            <div class="col-sm-4 form-group">
                ...
                <select class="form-select" name="location">
                    <option value="0" selected
                        ...
                        <?php echo translate("location_placeholder") ?></option>
                    <?php
            ...
            <div class="col-sm-4 form-group">
                ...
                <select class="form-select" name="industry">
                    <option value="0" selected
                        ...
                        <?php echo translate("industry_placeholder") ?></option>
                    <?php
            ...
            <div class="col-sm-12"></div>
            <div class="col-sm-4 form-group">
                <label for="jobType"><?php echo translate("jobType_label") ?></label>
            ...
            <div class="col-sm-4 form-group">
                <label for="applicationDeadline"><?php echo translate("applicationDeadline") ?></label>
        ...
        <div class="form-group text-center">
            ...
            <button type="submit" name="addJob"
                class="btn btn-primary"><?php echo translate("publish_button") ?></button>
        </div>
    </form>
</div>

        ...
        <div>
            <div class="goBackLink mb-3">
                ...
                if (Validator::ownsResource($employerView->getEmployer_id())) {
                    ...
                    echo '<a
                    href="index.php">' . translate("goBack") . '</a>';
                }
                ?>
            </div>
        </div>
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="col-sm-4">
                        ...
                        <a class=" btn editProfileButton" style="text-align: center; margin-top: 5px; padding: 3px;"
                            href='editcompanyprofile.php?id=<?php echo $employerView->getEmployer_id(); ?>'>
                            <?php echo translate("edit_profile_button") ?>
                        </a>
                        <?php } else {

                ...
                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <div class="profile-header">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><b><?php echo translate("employer_name_label")?>: </b> <?php echo $employerView->getCompanyName(); ?></li>
                            <li class="list-group-item"><b><?php echo translate("orgnumber_label")?>:</b> <?php echo $employerView->getOrganizationNumber(); ?></li>
                            <li class="list-group-item"><b><?php echo translate("phone_label")?>:</b> <?php echo $employerView->getPhonenumber(); ?></li>
                            <li class="list-group-item"><b><?php echo translate("email_label")?>:</b> <?php echo $employerView->getEmail(); ?></li>
                            <li class="list-group-item"><b><?php echo translate("location")?>:</b> <?php echo $employerView->getLocationName(); ?></li>

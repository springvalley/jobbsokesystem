            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-8">
                        ...
                        <textarea class="form-control" rows="5" id="coverletter" name="coverletter" aria-describedby="coverletter" placeholder="<?php echo translate("motivational_text_placeholder") ?>"></textarea>
                    ...
                    <div class="form-group col-md-8">
                        <label for="formFile" class="form-label"><?php echo translate("upload_otherDocuments_label") ?></label>
